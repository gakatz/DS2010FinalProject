...
x_training, x_testing, y_training, y_testing = train_test_split(x, y, train_size=0.75, random_state=42)

x_training.to_csv('MarathonDataXTraining.csv')
y_training.to_csv('MarathonDataYTraining.csv')
x_testing.to_csv('MarathonDataXTesting.csv')
